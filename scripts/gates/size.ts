...
// ошибка инструмента.
//
// ВНИМАНИЕ: машинного определения «initial JS» ещё нет — открытый вопрос Q-149, которым
// помечена задача T-016. До его закрытия строка NFR-03 меряет весь JS сборки; на заглушке
// его ноль байт, и это тоже наблюдаемый факт, а не умолчание.
