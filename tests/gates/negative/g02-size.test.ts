...
describe('G-02 на нарушающей сборке', () => {
  it(
    'валит сборку, чей initial JS больше бюджета, и называет маршрут',
    async () => {
  ...
  it(
    'валит бюджет, чей путь не нашёл файла при нашедших соседях',
    async () => {
      const detail = await failureOf('G-02', {
  ...
  it(
    'валит маршрут на спецификаторе, не разрешающемся в файл сборки, в каждой форме',
    async () => {
