...
// D-106 п. 2: каждый случай поднимает гейт отдельным процессом в каталоге фикстуры, и своего
// конфига рядом с набором нет — вторая точка описания прогонов разошлась бы с этой.
