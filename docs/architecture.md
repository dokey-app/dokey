...
| Событие аналитики | PostgreSQL под Umami | К-4 | **12 месяцев** (D-113) | Удаление ежемесячным заданием на VPS, рядом с дампом базы |
