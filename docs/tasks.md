...
- 2026-09-10 T-209 `c5ad677` — правки решений D-115…D-150 доведены по документам: ENT-29 семью полями, шесть категорий отказа, пять имён событий, PD-05/PD-06/PD-08 сняты, три списка на SCR-10
