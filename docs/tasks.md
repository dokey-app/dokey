...
- [ ] T-226 — продлить `dokey.ru` на несколько лет вперёд (D-162 п. 4, SEC-12; T-001 закрыта с оплатой на год решением PO 2026-09-16): границы — `infra/dns/README.md`, строка «Дата истечения»; готово — `paid-till` в whois `whois.tcinet.ru` не раньше 2028-08-28
