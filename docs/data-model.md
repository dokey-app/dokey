...
| **К-4 · Аналитика** | Umami на своём VPS за прокси на своём origin `dokey.app/s/event` | **12 месяцев** (D-113): удаление ежемесячным заданием, число публикуется на SCR-10 | ROLE-03 | ENT-28, ENT-29 |
