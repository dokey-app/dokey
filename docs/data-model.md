...
| **К-4 · Аналитика** | Umami на своём VPS за прокси на своём origin `dokey.ru/s/event` | **12 месяцев** (D-113): удаление ежемесячным заданием, число публикуется на SCR-10. Дамп базы шифруется до записи на носитель и живёт не дольше записей в базе (D-169) | ROLE-03 | ENT-28, ENT-29 |
...
| `sitemap.xml` | Есть, совпадает с реестром (G-07) | Отсутствует: краулера во внутреннем контуре нет, а адреса `dokey.ru` в образе делали бы документ невалидным |
