...
| 2 | Формулировка «Мы ничего не отправляем» | Запрещена как неточная: аналитика уходит через свой origin `dokey.ru/s/event`, и формулировка обязана это выдерживать |
