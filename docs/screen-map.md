...
- **Признак «повторный визит»** живёт в закрытом списке служебных ключей — в P0a в нём ровно один
  ключ, и он опубликован на SCR-10 (D-71 п. 1).
...
**Данные.** ENT-29 закрытый список полей · ENT-28 событие и адрес прокси `dokey.app/s/event` ·
ENT-24 объяснение счётчика · закрытый список служебных ключей (D-71 п. 1) · раздел «границы измерения»:
расширения браузера, читающие DOM, и молчащая при DNT/GPC аналитика (D-72 п. 3) · ENT-26 профиль сборки.
